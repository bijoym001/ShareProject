    ...
    <div className="flex h-screen bg-gray-50 text-gray-800 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 bg-white border-b border-gray-200 px-8 flex items-center justify-between shadow-sm">
          <h1 className="text-2xl font-semibold capitalize tracking-tight text-gray-800">{activePage}</h1>
          <div className="flex items-center gap-6">
            <input 
              type="text" 
              placeholder="Search anything..." 
              className="bg-gray-100 border border-gray-300 rounded-3xl px-5 py-3 w-80 focus:outline-none focus:border-blue-600 text-sm"
            />
